...
diagnosisDF <- as.data.frame(controlCoeff)
diagnosisDF$SchizophreniaCoeff <- as.numeric(positiveCoef.exact)
diagnosisDF$controlProbes <- probeList[order(abs(diagnosisDF$controlCoeff))]
diagnosisDF$controlProbesImpact <- diagnosisDF$controlCoeff[order(abs(diagnosisDF$controlCoeff))]
diagnosisDF$schizophreniaProbes <- probeList[order(abs(diagnosisDF$SchizophreniaCoeff))]
diagnosisDF$schizophreniaProbesImpact <- diagnosisDF$SchizophreniaCoeff[order(abs(diagnosisDF$SchizophreniaCoeff))]
diagnosisDF
```
